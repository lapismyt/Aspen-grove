...
public class AttachedToFruitLeavesDecorations extends AttachedToLeavesDecorator {

    public static final MapCodec<AttachedToFruitLeavesDecorations> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    ).apply(instance, AttachedToFruitLeavesDecorations::new));


    private final Block leavesBlock;

    public AttachedToFruitLeavesDecorations(float probability,int exclusionRadiusXZ,int exclusionRadiusY,Block leavesBlock,BlockStateProvider blockProvider,int requiredEmptyBlocks,List<Direction> directions) {
    ...
    protected @NotNull TreeDecoratorType<?> type() {
        return NBTfiedDecorationsTypes.ATTACHED_TO_FRUIT_LEAVES;
    }
